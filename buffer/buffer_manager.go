...
func (man *BufferManager) Pin(block file.Block) (*Buffer, error) {
...
func (man *BufferManager) tryToPin(block file.Block) *Buffer {
...
func (man *BufferManager) findExistingBuffer(block file.Block) *Buffer {
...
func (man *BufferManager) assignBufferToBlock(buf *Buffer, block file.Block) {
